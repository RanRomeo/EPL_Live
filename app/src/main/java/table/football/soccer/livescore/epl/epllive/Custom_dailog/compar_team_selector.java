...
import table.football.soccer.livescore.epl.epllive.Adapters.compareTeam_A_selector_adapter;
...
public class compar_team_selector  extends DialogFragment implements compareTeam_A_selector_adapter.OnItemClickListener {

    View v;
    ImageButton CloseButton;
    RecyclerView TeamRecyclerView;
    List<notification_team_id> Team_list;
    compareTeam_A_selector_adapter faveTeamSettingAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        faveTeamSettingAdapter = new compareTeam_A_selector_adapter(Team_list,this,getContext());
