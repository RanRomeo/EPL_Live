...
public class PrefManager_google_interAd_settings {

    Context context;

    public PrefManager_google_interAd_settings(Context context) {
        this.context = context;
    }

    //used when ad is clicked
    public void SaveClickedTime(){
        SharedPreferences sharedPreferences = context.getSharedPreferences("Inter_MyGoogleAdsettings", Context.MODE_PRIVATE);
