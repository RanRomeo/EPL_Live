...
public class Fragment_player_assits extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // Get_player_stat_data getPlayerStatData = new Get_player_stat_data(statPlayerModels,statPlayerAdapter,getContext());
        //https://footballapi.pulselive.com/football/stats/ranked/players/goal_assist?page=0&pageSize=20&compSeasons=210&comps=1&compCodeForActivePlayer=EN_PR&altIds=true
     //   getPlayerStatData.loadStatData("");

        loadStatData("https://footballapi.pulselive.com/football/stats/ranked/players/goal_assist?page=0&pageSize=20&compSeasons=210&comps=1&compCodeForActivePlayer=EN_PR&altIds=true"
                ...
                try{
                   ...
                   // System.out.println(heroArray.length());
                    ...
                    for(int i=0;i<heroArray.length();i++){
                        ...
                        String TeamName = TeamData.getString("shortName");
                        //for image id
