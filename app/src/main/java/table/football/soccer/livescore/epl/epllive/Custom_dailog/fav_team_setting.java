...
import table.football.soccer.livescore.epl.epllive.Adapters.fave_team_setting_adapter;
...
public class fav_team_setting  extends DialogFragment implements fave_team_setting_adapter.OnItemClickListener {
    ...
    fave_team_setting_adapter faveTeamSettingAdapter;
    //private fave_team_setting_adapter.OnItemClickListener listener;
    //Close dialog
    @Override
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
      ...
      //  v.getWindow().setLayout(ViewGroup.LayoutParams.MATCH_PARENT,ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        faveTeamSettingAdapter = new fave_team_setting_adapter(Team_list,this,getContext());
