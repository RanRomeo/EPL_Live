...
public class Fragment_penalties_saved extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // getPlayerStatData.loadStatData("");
        loadStatData("https://footballapi.pulselive.com/football/stats/ranked/players/penalty_save?page=0&pageSize=20&compSeasons=210&comps=1&compCodeForActivePlayer=EN_PR&altIds=true",
