...
public class Fragment_team_stats_clearance extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        g.loadStatData(v,"https://footballapi.pulselive.com/football/stats/ranked/teams/total_clearance?page=0&pageSize=20&compSeasons=210&comps=1&altIds=true");
        return v;
    }
