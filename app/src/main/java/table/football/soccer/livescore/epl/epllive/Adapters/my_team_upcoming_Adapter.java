    ...
    public class my_team_upcoming_Adapter  extends  RecyclerView.Adapter<my_team_upcoming_Adapter.Viewholder>   {


        List<match_model> matchModelList;
            Context context;

    public my_team_upcoming_Adapter(List<match_model> matchModelList, Context context) {
    ...
    public Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rec_my_team_upcoming_match,parent,false);
    ...
    final match_model MatchModel = matchModelList.get(position);
            ...
            String placeName = MatchModel.getStadiumName()+","+MatchModel.getCityName();
            holder.match_stadium.setText(placeName);
