...
public class Fragment_result extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // System.out.println(listItems);
        ...
        loadHeroList(new WebView(getContext()).getSettings().getUserAgentString());
    ...
    private void loadHeroList(final String UserAgent){
...
//score
                            //System.out.println(GameID+" " + HomeTeam + " "  + " " +HomeTeamSccore + " VS " + AwayTeam + " "+HomeTeamSccore +" "  + AwayTeamID+"  " +convertDate(DateInMillis,"hh:mm a"));
                          //  Log.d("ScoreResult"," " +GameID+" " + HomeTeam + " "  + " " +HomeTeamSccore + " VS " + AwayTeam + " "+HomeTeamSccore +" "  + AwayTeamID+"  " +convertDate(DateInMillis,"hh:mm a"));
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                params.put("Referer", "https://www.premierleague.com/results");
