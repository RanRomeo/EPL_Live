...
public class Fragment_team_fixtures extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_team_fixtures, container, false);
        // Inflate the layout for this fragment
        recentModelList = new ArrayList<>();
        recyclerView = v.findViewById(R.id.Team_fixture_rec);
        teamFixtureAdpter = new Team_fixture_Adpter(recentModelList,getContext());
       ...
       // DividerItemDecoration itemDecoration = new DividerItemDecoration(v.getContext(),linearLayoutManager.getOrientation());
        ...
        getTeamFixture(TeamID,new WebView(getContext()).getSettings().getUserAgentString());
        return v;
