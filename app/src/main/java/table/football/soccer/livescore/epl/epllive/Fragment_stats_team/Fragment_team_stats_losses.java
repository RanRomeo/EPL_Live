...
public class Fragment_team_stats_losses extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        g.loadStatData(v,"https://footballapi.pulselive.com/football/stats/ranked/teams/losses?page=0&pageSize=20&compSeasons=210&comps=1&altIds=true");
        return v;
    }
}